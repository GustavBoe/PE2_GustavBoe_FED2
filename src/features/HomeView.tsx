...
export default function HomeView(){
  ...
  return(
    ...
    <div className="flex flex-row items-center mt-5 h-100 w-95 border border-border inset-shadow-sm shadow-[inset_-4px_0_4px_-2px_rgba(0,0,0,0.1)]  rounded-md md:w-190 overflow-scroll snap-x snap-mandatory scroll-smooth scrollbar-x">
